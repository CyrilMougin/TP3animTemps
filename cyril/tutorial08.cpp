...
int main( void )
{
	...
	GLuint cubeprogramID = LoadShaders("cube.vertexshader", "cube.fragmentshader");

	// Get a handle for our "MVP" uniform
	GLuint MatrixID = glGetUniformLocation(programID, "MVP");
	GLuint ViewMatrixID = glGetUniformLocation(programID, "V");
	GLuint ModelMatrixID = glGetUniformLocation(programID, "M");
	GLuint trans = glGetUniformLocation(cubeprogramID, "trans");
	...
	do{
		...
		glUniformMatrix4fv(trans, 1, GL_FALSE, &translation[0][0]);
		glUniform4f(color, 0.0f, 0.0f, 0.0f, 0.3f);
